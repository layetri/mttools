...
<script>
  export default {
    ...
    data() {
      return {
        tools: [
            {url: 'instrument-trainer', name: 'Instrument Trainer', type: ['online', 'green'], course: ['muzbas', 'red']},
            {url: 'midi-meet', name: 'MidiMeet', type: ['online', 'green'], course: ['general', 'gray']},
            //{url: '', name: '', type: ['', ''], course: ['', '']},
        ]
      }
    }
  }
